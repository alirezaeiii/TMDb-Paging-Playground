...
class TVShowDetailViewModel(private val api: TmdbApi,
    ...
    override fun getTrailers(id: Int): Observable<TmdbApi.VideoWrapper> = api.tvTrailers(id)

    override fun getCast(id: Int): Observable<TmdbApi.CastWrapper> = api.tvCast(id)
}